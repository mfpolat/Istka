 ...
 */
public class CustomBitmapTileSourceBase implements ITileSource,OpenStreetMapTileProviderConstants {
    ...
    public CustomBitmapTileSourceBase(final String aName, final ResourceProxy.string aResourceId,
